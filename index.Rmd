...
The statistical programming language R will be used to generate visualizations and perform basic modeling. When doing work, you will be able to use any programming language or software package of your choice.

This class is designed to be a research-focused course where you produce two high-level group projects that could potentially get you an internship or job in sports analytics or data science. You will not be taught how to code in this course so you will need a strong background in statistical programming in R or Python. Prior experience in visualization software like Tableau or Power BI is also a plus. Since this a 500-level course, I have extremely high expectations for the quality of these projects. Originality and creativity is essential. Papers should be professionally written and edited by the individuals in the group.
...
-   Personal Trainers:
    - Lily Feingold (lilyfein@unc.edu)
    - Jaehong Kim (jaehkim@unc.edu)

-   Syllabus: [**Section 1**](Syllabi\STOR%20538%20Section%201%20Syllabus.pdf)

-   Game Days: M-F, 1:15PM - 2:45PM, Hanes 130

-   Office Hours:

    -   Press Conference (Dr. Mario)
        -   M-F, 2:45PM - 3:15PM
        -   Location: Hanes 403
    -   Training Day (Lily)
        -   TW, 11:30AM - 12:30PM
        -   Location: [Zoom](https://unc.zoom.us/j/92167298335)
    -   Training Day (Jaehong)
        -   ThF, 11:30AM - 12:30PM
        -   Location: [Zoom](https://unc.zoom.us/j/3785342085)
        -   Passcode: 1Kz4aJ
...
-   Bookmark this [**course website**](https://supermariogiacomazzo.github.io/STOR538_WEBSITE/) in your browser
...
-   [An Introduction to Statistical Learning](Textbooks%20in%20R/An%20Introduction%20to%20Statistical%20Learning.pdf)

-   [R for Data Science](Textbooks%20in%20R/R%20for%20Data%20Science-%20Import,%20Tidy,%20Transform,%20Visualize,%20and%20Model%20Data.pdf)
...
- [Triangle Sports Analytics Competition (TSAC)](https://triangle-sports.github.io/)
...
|JUL 2| Baseball IV (Cont.)| [Slides](Slides/Baseball 4/Baseball_4_Lecture.pdf) |Ch. 4-5 MATH, [Web 1](http://www.programmingr.com/monte-carlo-simulation-in-r/), [Web 2](https://www.baseballprospectus.com/news/article/878/pitching-and-defense-how-much-control-do-hurlers-have/)|
| JUL 3 | Independence Day               |No Class |  |
|JUL 6| Baseball V| [Slides](Slides/Baseball 5/Baseball_5_Lecture.pdf) |Ch. 6 MATH, [Web](https://batsandstats.com/2016/08/03/one-of-my-favorite-baseball-stats/)|
...
|JUL 7| Baseball VII | [Slides](Slides/Baseball 7/Baseball_7_Lecture.pdf) |Ch. 11,16 MATH, [Article 1](Articles/Baseball/Baseball2_Albert.pdf), [Article 2](Baseball_Arbseman_Strogatz.pdf)|
|JUL 8| Baseball VII (Cont.) | [Slides](Slides/Baseball 7/Baseball_7_Lecture.pdf) |Ch. 11,16 MATH, [Article 1](Articles/Baseball/Baseball2_Albert.pdf), [Article 2](Baseball_Arbseman_Strogatz.pdf)|
|        |                            | ||                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
...
|JUL 14| Basketball IV| [Slides](Slides/Basketball 4/Basketball_4_Lecture.pdf) |Ch. 31,34 MATH, [Web 1](https://www.basketball-reference.com/about/bpm2.html)|
|JUL 15| Basketball IV (Cont.)| [Slides](Slides/Basketball 4/Basketball_4_Lecture.pdf) |Ch. 31,34 MATH, [Web 1](https://www.basketball-reference.com/about/bpm2.html)|
...
|| Basketball VI | [Slides](Slides/Basketball 6/Basketball_6_Lecture.pdf) |Ch. 38 MATH, [Web 1](https://www.inpredictable.com/2016/05/endgame-strategy-in-nba.html), [Web 2](http://www.82games.com/lawhorn.htm),[Article 1](Articles/Basketball/Basketball_Gill.pdf), [Article 2](Articles/Basketball/Basketball_Kenter.pdf), [Article 3](Articles/Basketball/Basketball_Annis.pdf)|
|JUL 16 | Football I | [Slides](Slides/Football 1/Footballl_1_Lecture.pdf) |Ch. 18 MATH|
|JUL 17| Work on Project| No Class||
|JUL 20 | Football I (Cont.) | [Slides](Slides/Football 1/Footballl_1_Lecture.pdf) |Ch. 18 MATH|
...
|JUL 21| Football III | [Slides](Slides/Football 3/Footballl_3_Lecture.pdf) |Ch. 20 MATH, [Web 1](http://www.advancedfootballanalytics.com/2010/01/expected-points-ep-and-expected-points.html), [Article 1](Articles/Football/Football_CarterMachol.pdf), [Article 2](Articles/Football/Football_Romer.pdf), [Article 3](Articles/Football/Football_Goldner.pdf) |
...
<!-- |DEC 2| Final Regular Season Quiz | Final Class || -->
...
There will be at least two assignments designed to test proficiency in data science. This class involves group projects that require strong data science skills. These assignments will require you to perform data science tasks with data and must be done individually without the help of any other students in the course. The work required for these assignments will not be taught in the course but will come from material and topics taught in STOR 320 and/or STOR 455 and/or other provided material. These assignments will be submitted to Canvas by the due date. You will receive a 25% penalty for less than one day late, 50% penalty for less than two days late, and 75% penalty for less than three days late. After three days, practice assignments will not be accepted. Expect these assignments early in the semester.
...
The playoff will be a predictive modeling project for actual MLB games. The primary goal of this project is to design models for prediction of three variables -- $Spread$, $Runs$, and $K$. Below you can find clear definitions of these three outcome variables:

- $Spread = \textrm{Home Runs} - \textrm{Away Runs}$

- $Runs = \textrm{Home Runs} + \textrm{Away Runs}$

- $K = \textrm{Home Strikeouts} + \textrm{Away Strikeouts}$

It is imperative that you follow these specifications. Your group will be making predictions of the three variables for all MLB games between July 11 and July 18, inclusively. Your predictions should be saved in the CSV called **[Predictions](https://github.com/SuperMarioGiacomazzo/STOR538_WEBSITE/blob/master/Playoff/Predictions.csv)**. Here you will find missing values where future predictions will be placed. This completed file (CSV) should be submitted along with a paper (PDF) summarizing your methodology. You will not only be graded by your methodology, but also by your predictive accuracy. The variables, $Spread$, $Runs$, and $K$ will all be evaluated by mean absolute error (MAE). For each of the variables, the top group will get 3 points, the middle 2 groups will get 2 points, and the bottom group will get 1 point. All three variables are numeric. If you fail to submit predictions on time or the predictions are not numeric values, you will get 0 points and your predictions will not be considered.
...
- [MLB Stats API](https://pypi.org/project/MLB-StatsAPI/)
- [pybaseball](https://github.com/jldbc/pybaseball)


For the engineering of new variables, consider creating differences and ratios between the stats for the home and away teams. Also, it may be useful to create variables that represent past information such as moving averages or lagged variables. You should be able to explain and defend the variables you create. This is your opportunity to test different ideas, and I do not care if any of the variables you engineer end up in your final model for prediction. You should defend any engineered variables on how you think they will be specifically helpful for predicting the three variables you are being asked to predict.

Your study should be summarized in a paper of at least 5 pages. The paper (PDF) and predictions (CSV) should be submitted on Canvas before 11:59PM on July 10, 2026. 

<!-- Your study should be summarized in a paper of at least 5 pages. The paper (PDF) and predictions (CSV) should be submitted on Canvas before 11:59PM on July 10, 2026. Each group should have their own paper and predictions, but both need to be submitted by every member of the group. Also, each group member needs to assess the contribution value of the other members of the team on a scale from 0 (Bad) to 6 (Excellent). Use the Google form provided on the course website. -->

This project is extremely demanding. If you fail to submit the predictions on time, your will get 0's for all of the predictions. If you fail to complete the paper on time, then you will get a penalty dependent on how late you turn it in. If I discover that the methodology in your paper doesn't lead to your predictions or your predictions were generated using any form of AI where the work is not your own and the methodology is unable to be explained, I will report this as an academic violation and require you to show me your code and prove to me that your predictions are valid and from your methodology. At a minimum, I will do whatever I can to ensure you get a 0 on this assignment.
...
<!-- |2/20 |2/22|Start Writing Section 1 of Paper| -->
<!-- |2/22|3/4|Each Group Member Builds and Evaluates One Model for Each Variable| -->
<!-- |3/4|3/6|Start Writing Sections 2-4 of Paper| -->
<!-- |3/6|3/11|Implement Models to Make Predictions and Finish Paper| -->
<!-- |3/11|3/13|Edit and Submit Paper + Predictions| -->
<!-- |||| -->

On the first page, you should title your paper, give your group number, and give the names of the team members who contributed. If someone didn't do any work, don't put their name on it so I can give them a 0. The content of the paper should be organized in the following 4 subsections:
...
If you use any ideas or methods from others, provide citations. Be transparent about all uses of AI 

### 3) Methodology for $Runs$

You should clearly describe your group's best predictive model for $Runs$ and the steps you took to get there. Discuss what variables were useful and useless for predicting $Runs$. Since $Runs$ is counting variable it could be skewed, I highly recommend nonlinear transformations. To ensure you are seeking the best model for prediction, I highly advise considering many different types of models (neural nets, regression  trees, time series, etc.), utilizing cross-validation/out-of-sample testing, and adding interaction/polynomial terms. In this part, you should chronologically write about everything your group did to find the "best" model. Challenge yourselves to a thorough investigation from multiple angles and organize your process professionally for an audience with basic understanding in statistics and the sport. You are not required to present tables or figures, but these can be used to defend why the model you are calling the "best" is actually best. Talk about all of the models your group considered, but put some extra attention on describing your "best" model since this is the model that your group used to generate predictions. For example, if your "best" model is a linear regression model, you can show the coefficients in a table or write it out mathematically. In more advanced machine learning methods, I should know every value of every hyperparameter/tuning parameter and how your group chose those values. Finally, make sure that you explain how your group used the "best" model to generate predictions for future games where everything is unknown. Just giving a description of your best model is not enough if you don't explain exactly how that model was used to make real predictions.

Some groups want to predict $Spread$ and $Runs$ only using separate models for home runs and away runs. I think if you are going to do that there should be some comparison of your models for points to other models for the $Spread$ and $Runs$ variables directly.

### 4) Methodology for $K$

You should clearly describe your group's best predictive model for $K$ and the steps you took to get there. Discuss what variables were useful and useless for predicting $K$. This variable may be highly skewed. To ensure you are seeking the best model for prediction, I highly advise considering many different types of models (neural nets, regression  trees, time series, etc.), utilizing cross-validation/out-of-sample testing, and adding interaction/polynomial terms. In this part, you should chronologically write about everything your group did to find the "best" model. Challenge yourselves to a thorough investigation from multiple angles and organize your process professionally for an audience with basic understanding in statistics and the sport. You are not required to present tables or figures, but these can be used to defend why the model you are calling the "best" is actually best. Talk about all of the models your group considered, but put some extra attention on describing your "best" model since this is the model that your group used to generate predictions. For example, if your "best" model is a linear regression model, you can show the coefficients in a table or write it out mathematically. In more advanced machine learning methods, I should know every value of every hyperparameter/tuning parameter and how your group chose those values. Finally, make sure that you explain how your group used the "best" model to generate predictions for future games where everything is unknown. Just giving a description of your best model is not enough if you don't explain exactly how that model was used to make real predictions.

Again, if you are going to solve this problem by predicting the strikeouts for a team and then adding them up, you should justify this by using cross-validation to compare prediction accuracy to models designed to directly predict the total strikeouits.
...
| Criteria | 0 | 1 | 2 | 3 |
|:-----------:|:------:|:------:|:------:|:------:|
|Title Page |Instructions Not Followed|Missing 2 Elements|Missing Entire Element|Excellent|
...
|Spread: Prediction|None|Bottom| Middle |Top|
|Runs: Methodology|Poor|Lazy But Well Explained|Clear, Thorough, but Lacking Innovation|Clear, Innovative, and Thorough|
|Runs: Best Model|Poor Description|Adequate Description|Good Description|Excellent Description|
|Runs: Prediction|None|Bottom|Middle|Top|
|K: Methodology|Poor|Lazy But Well Explained|Clear, Thorough, but Lacking Innovation|Clear, Innovative, and Thorough|
|K: Best Model|Poor Description|Adequate Description|Good Description|Excellent Description|
|K: Prediction|None|Bottom|Middle|Top|
|Spelling/Grammar|>5 Errors| 3-5 Errors|1-2 Errors|No Errors|
...
5.  As a Team, Track the Data in a Spreadsheet
    ...
    -   Each Group Member is Expected to Participate in the Data Collection and if Group Member Refuses or is Unable to Participate in the Data Collection by TBD, then I Will Remove that Group Member and Require that Individual to Collect 200 Observations and Write Their Own Paper

To ensure that every group stays on a reasonable pace, I will require each member of your group to submit the exact portion of the dataset that they collected. I am expecting 50 or more observations per person. This needs to be submitted to **Canvas** before 11:59PM on July 20. For each member of the group, I am expecting the same number of variables and exact same variable names to show that your group worked together and coordinated efforts. Also, each group member can assess the contribution value of the other members of the team on a scale from 0 (Bad) to 3 (Excellent). Fill out the appropriate Google Form in the section below called **Team Sport** to turn in your ratings of your group members. Your value will be determined by the average score of the other members in your group.

Your study should be summarized in a paper with at least 5 pages (a minimum of 3 pages worth of writing). The paper should be submitted on **Canvas** before 11:59PM on the last day of class, July 28. Submit the paper as a PDF only. Each group should have their own paper, but the paper needs to be submitted by every member of the group.
...
Also, each group member can assess the contribution value **twice** of the other members of the team on a scale from 0 (Bad) to 3 (Excellent). One time you will fill it out on July 20 and another time on the final presentation day, July 28. Fill out the appropriate Google Form in the section below called **Team Sport** to turn in your ratings of your group members. Your value will be determined by the average score of the other members in your group.

Finally, each group will present their group's work using a slideshow presentation during our scheduled final exam period which is July 28 at 11:30AM in our classroom. Presentation slides should be submitted on **Canvas** prior to 11:30AM on July 28 by each group member. On July 28, each of you will have 5 to 7 minutes to present your work to the class. Your presentation should be persuasive as if you are talking to a group of coaches or players. I recommend starting with the purpose of your project and talk briefly about data collection. All group members involved should be utilized as evenly as possible in the presentation. It should be clear that your group has practiced your presentation several times prior. I am expecting a high level of eye contact, smooth transitions, slides with few words, no verbatim reading, etc. I want your slides to look absolutely stunning as if you were presenting this in a job interview. If you do cannot attend the day of presentations and you do not have a university approved reason for missing, you will automatically get a 5 point penalty.
...
The championship round is worth a total of 72 points based on the following rubric:
...
|        Presentation Slides         |                 Bad                 |              Some Major Issues               |               Minor Issues                |       Beautiful and Well-Organized        |
...
Important: You can make your data public on the ScoreNetwork by following the steps here <https://data.scorenetwork.org/submit-data.html>. This network would increase the exposure for your dataset across the world. If others use your data in future research, they will need to cite you. 
...
| JUN 30 (1:15PM) |                                                               |                     |       RS1        |             |                  |
| JUL 2 (1:15PM) |                                                               |         GS2         |                  |             |                  |
| JUL 3 (11:59PM) | [PR1](Practice/Practice1.pdf)([.zip](Practice/Practice1.zip)) |                     |                  |             |                  |
| JUL 3 (11:59PM)  | [PR2](Practice/Practice2.pdf)([.zip](Practice/Practice2.zip)) |                     |                  |             |              |
| JUL 7 (1:15PM)  |                                                               |                     |       RS2        |             |                  |
| JUL 9 (1:15PM) |                                                               |         GS3         |                  |             |                  |
| JUL 13 (11:59PM)  |                                                               |                     |                  |             |     C (Data)     |
| JUL 14 (1:15PM) |                                                               |                     |       RS3        |             |                  |
| JUL 16 (1:15PM) |                                                               |         GS4         |                  |             |                  |
| JUL 21 (11:15AM)  |                                                               |                     |       RS4        |             |                |
| JUL 28 (11:30AM) |                                                               |                     |                  |             |    C (Paper)     |
| JUL 28 (11:30AM)     |                                                               |                     |                  |             | C (Presentation) |
|                  |                                                               |                     |                  |             |                  |

# **Team Sport**

Many of the assessments in this course will be done in a teams of 2 playas randomly chosen. For each team-based assignment, you will be given a different team. This will force you to interact with the majority of the class throughout the semester. After each team-based assignment, you will grade the contribution of your teammates on a scale from 0 to 3, and this will contribute to your overall grade for the given assignment. A decent portion of your final grade will be influenced by this. The following link contains all teams alphabetically: [**All Teams**](Group%20Assignments/allTeams.pdf)
...
|:--------:|:--------:|:--------------------------------------------------:|
|  JUN 25  |    GS1     |      [Value for GS1](https://docs.google.com/forms/d/e/1FAIpQLSdqPjLn-IrA-hqBUCNHbe8sgf3kxMSPNaLEE2mg_S31LAGuvg/viewform?usp=sf_link)|
|  JUL 2 |    GS2     |      [Value for GS2](https://docs.google.com/forms/d/e/1FAIpQLScQ967bd2WRx9nmMDfeoJD5UZZTFN4bPjYwyvXXBGw7ZEQBKA/viewform?usp=sf_link)|
|  JUL 9  |    GS3     |      [Value for GS3](https://docs.google.com/forms/d/e/1FAIpQLSeTAEas1kqxGZmJYQ640iX9AQIlgcirVJoxciEnn2UU7WcqAQ/viewform?usp=sf_link)|
|  JUL 16  |    GS4     |      [Value for GS4](https://docs.google.com/forms/d/e/1FAIpQLSchVRUxeiKYCfcRBWQ8Y85najkEO0FgPzhNFnYmmwIwWOp7VA/viewform?usp=sf_link)|
|  JUL 20   |  C (Data)  |                                       [Value for Championship 1](https://forms.gle/Z85rGWemhw24m3qj8)|
|  JUL 28 | C (Paper)  | [Value for Championship 2](https://docs.google.com/forms/d/e/1FAIpQLSeIoeRjDLc0FtRn8qvxzhFb5ebaVc4xjh1xdlnC8saEtgIlxA/viewform?usp=sharing)|
|          |            |                                                                                                                                             |

# **Playoff Results**

The predictions of all teams can be accessed from the hyperlinks below. These three files contain predictions, actual values, calculations of MAE, and ranking. If you find any mistakes that cause the grades to change, I will adjust them.
...
The table below shows each group's MAE for $Spread$, $Runs$, and $K$, respectively. Also, you will see your group ranking for each of the three variables. It may be helpful to sort the table for each variable to see where your group is currently ranked.
